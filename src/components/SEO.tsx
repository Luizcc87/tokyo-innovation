...
export function SEO({
  ...
  const fullTitle = title.includes('Tokyo Innovation') ? title : `${title} | Tokyo Innovation`;
  ...
  const organizationJsonLd = {
    ...
    description: 'Automação com IA em produção em poucos dias. Santa Rosa/RS e Noroeste Gaúcho.',
    address: {
      '@type': 'PostalAddress',
...
export const pageSEO = {
  home: {
    ...
    description: 'Automação com IA funcionando + métrica antes/depois. Primeiro resultado em até 21 dias. Santa Rosa/RS e Noroeste Gaúcho.',
    canonical: '/',
  },
  dashboards: {
    title: 'Dashboards com IA | Tokyo Innovation',
    description: 'Transforme dados em decisão: dashboards com IA, previsões e alertas. Números do Negócio em linguagem simples.',
    canonical: '/solucoes/dashboards',
  },
  whatsapp: {
    title: 'IA no WhatsApp | Tokyo Innovation',
    description: 'WhatsApp organizado com IA: triagem, atendimento 24/7, follow-up e conversão. Resultado mensurável.',
    canonical: '/solucoes/whatsapp',
  },
  operations: {
    title: 'Automação de Processos | Tokyo Innovation',
    description: 'Reduza retrabalho e rotina manual. Automação com IA, integrações e método para resultado mensurável.',
    canonical: '/solucoes/operacao',
  },
  nichos: {
    title: 'Nichos | Tokyo Innovation',
    description: 'Seu nicho tem processos repetitivos? Então tem IA. Exemplos por setor com ganhos claros.',
    canonical: '/nichos',
  },
  notFound: {
